    ...
    return (<View style={{ flexDirection: 'row', gap: 10, flexWrap: 'wrap' }} {...containerStyle}>
            ...
            return (<Pressable key={option.index} onPress={function () {
                    onSelect(option);
                            ...
                            <View style={{ flexDirection: 'row', alignItems: 'center', height: 52, borderWidth: 1, paddingLeft: 10, paddingRight: 20, borderRadius: 26, borderColor: setColor, flex: 1, backgroundColor: isSelected ? setColor + '10' : undefined }}>
                                ...
                                <Text style={{ color: '#5E696E', marginLeft: 10, fontSize: 17 }} {...valueStyle}>
                                    {option.value}
                                </Text>
                            </View>
                        </Pressable>);
