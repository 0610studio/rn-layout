...
var RadioGroup = function (_a) {
    var options = _a.options, value = _a.value, onSelect = _a.onSelect, containerStyle = _a.containerStyle, valueStyle = _a.valueStyle, _b = _a.normalColor, normalColor = _b === void 0 ? '#E7EDF0' : _b, _c = _a.selectedColor, selectedColor = _c === void 0 ? '#FFA900' : _c, minWidth = _a.minWidth, _d = _a.disabled, disabled = _d === void 0 ? false : _d;
            ...
            return (<Pressable key={option.index} onPress={function () {
                    ...
                    onSelect(option);
                            ...
                            <View style={{ flexDirection: 'row', alignItems: 'center', height: 50, borderWidth: 1, paddingLeft: 10, paddingRight: 20, borderRadius: 26, borderColor: setColor, flex: 1, backgroundColor: isSelected ? setColor + '10' : undefined }}>
                                ...
                                <Text style={{ color: '#757575', marginLeft: 10, fontSize: 17 }} {...valueStyle}>
                                    {option.value}
                                </Text>
                            </View>
                        </Pressable>);
